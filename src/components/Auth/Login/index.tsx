...
import { EyeIcon, EyeOffIcon, CrossIcon } from "lucide-react";
  ...
  return (
    <>
      ...
      <div className="w-full bg-layer-3 p-4 flex flex-col justify-start items-start min-h-screen gap-8">
        ...
        <div className="flex flex-col max-w-[600px] w-full mx-auto bg-layer-1 h-full p-5 shadow-custom-blue rounded-lg gap-4">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col">
            <div className="email-input-section relative mb-6">
              <input
                ...
                placeholder="Email"
                autoComplete="email"
                className="w-full h-[54px] p-3 bg-layer-1 border-[1.5px] border-[#eaf0fc] rounded-lg text-base leading-6 text-[#101828] transition-all duration-200 placeholder:text-[#667085] focus:border-[#0047cb] focus:ring-1 focus:ring-[#0047cb] focus:ring-opacity-100 focus:outline-none"
              />
            </div>
            ...
            <div className="password-input-section relative mb-2">
              <input
                ...
                className="w-full h-[54px] p-3 pr-11 bg-layer-1 border-[1.5px] border-[#eaf0fc] rounded-lg text-base leading-6 text-[#101828] transition-all duration-200 placeholder:text-[#667085] focus:border-[#0047cb] focus:ring-1 focus:ring-[#0047cb] focus:ring-opacity-100 focus:outline-none"
            ...
            {isError && (
              <div className="error-message-section flex items-start justify-center gap-3 p-4">
                ...
                <p className="text-text-error font-medium text-md">
                  Error
                </p>
                </div>
                <div>
