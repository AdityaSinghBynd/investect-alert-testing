...
// Images
import { X, Plus, Send, User, Mail, Loader2 } from 'lucide-react'
// Components
    ...
    >
      ...
      >
        ...
        <footer className="flex justify-end px-3 py-2">
          ...
          >
            Send Mail {emailSendMutation.isPending ? <Loader2 className="w-4 h-4 animate-spin" /> : <Mail className='w-4 h-4' />}
          </Button>
        </footer>
      </div>
    </div>
